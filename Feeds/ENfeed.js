...
export default class Enfeed extends React.Component{
   ...
   fetchnews= ()=>{
      fetch('http://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=a7108905c2e546dcae97a4b89f29cfed')
      .then((res) =>res.json())
      .then((response) =>{
         this.setState({
   ...
   sharearticle= async articles =>{
      ...
      <View style={styles.Container}>
                  ...
                  <View style={styles.Header}>
                     ...
                     <Text style={{color:"#333",fontSize:20,fontWeight:"400"}}>Entertainment</Text>
